...
| lock (locking) | ~5,700 | 520 | Partial | Table/record locks, wait graph + deadlock detection; basic wait queues with timeouts. |
...
- Wait queues are basic (no scheduling or priority handling)
